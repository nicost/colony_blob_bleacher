...
data_source = "/Users/xiaoweiyan/Dropbox/LAB/ValeLab/Projects/Blob_bleacher/Data/"\
                "20210203_CBB_nucleoliArsAndHeatshockTreatment/data/WT2"
save_name = 'dataAnalysis_2modes'
...
for s in range(len(dirs)):
    ...
    if analyze_organelle == 'nucleoli':
        ...
        if len(ctrl_nuclear_bg_pd_ft) != 0:
            ...
            pointer_nuclear_bg_ft_pd = pointer_nuclear_bg_pd[
                pointer_nuclear_bg_pd['frap_filter_%s' % fitting_mode] == 1]
            ...
            # raw intensity
            dis.plot_raw_intensity(pointer_nuclear_bg_pd, ctrl_nuclear_bg_pd_ft, fitting_mode, 'nuclear_bg',
                                   storage_path)
